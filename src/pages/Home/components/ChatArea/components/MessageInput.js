...
const MessageInput = ({
	...
	const renderFileAttach = () => {
		if (showFileAttach) {
			return (
				<div className="select-files-images-container">
					<div className="file-select-container">
						...
						{attachDocumentActive && (
							<p className="select-file-type">Documents</p>
						)}
					</div>
					...
					<div className="file-select-container">
						...
						{attachImageActive && (
							<p className="select-file-type">Images</p>
						)}
					</div>
				</div>
			);
	...
	return (
		<div className="message-input-container">
			<div className="files-send-container">
				...
				>
					{showFileAttach ? (
						<IoIosCloseCircleOutline size={32} style={iconStyles} />
					) : (
						<GrAttachment size={28} style={iconStyles} />
					)}
				</div>
			</div>

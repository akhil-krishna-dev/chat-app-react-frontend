        ...
        .post(`${BaseUrl}accounts/register/`,
           data
            ...
            .post(`${BaseUrl}accounts/login/`,
                ...
                const expireDate = new Date(response.data.expire)           
  ...
  return (
    <div className='register-container'>
        <div className='register-form-container'>
            ...
            <div className='input-container'>
                <input onChange={(event) => setConfirmPassword(event.target.value)} type='password' placeholder='confirm password' />
            </div>
            <SubmitButton handleSubmit={handleSubmit} action={"Register"} loader={loader}/>
